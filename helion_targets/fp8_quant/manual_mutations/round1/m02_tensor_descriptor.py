...
SHAPE_CONFIGS: dict[tuple, helion.Config] = {
    (1, 256, 64): helion.Config(block_sizes=[4], indexing="tensor_descriptor", num_warps=4, num_stages=2),
    (4, 512, 128): helion.Config(block_sizes=[8], indexing="tensor_descriptor", num_warps=4, num_stages=2),
    (16, 1024, 64): helion.Config(block_sizes=[32], indexing="tensor_descriptor", num_warps=4, num_stages=2),
    (1, 4096, 128): helion.Config(block_sizes=[8], indexing="tensor_descriptor", num_warps=4, num_stages=2),
    (8, 4096, 128): helion.Config(block_sizes=[32], indexing="tensor_descriptor", num_warps=4, num_stages=2),
