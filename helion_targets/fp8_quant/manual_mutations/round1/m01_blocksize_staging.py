...
SHAPE_CONFIGS: dict[tuple, helion.Config] = {
    ...
    (256, 4096, 128): helion.Config(block_sizes=[128], num_warps=8, num_stages=3),
    (256, 8192, 128): helion.Config(block_sizes=[128], num_warps=8, num_stages=3),
    (4096, 7168, 128): helion.Config(block_sizes=[256], num_warps=8, num_stages=4),
}
