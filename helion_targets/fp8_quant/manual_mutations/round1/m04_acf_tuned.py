...
FP8_MAX = 448.0
FP8_EPS = 1e-10
ACF_0 = "/opt/booster_pack/fp8_group_quant_0.acf"
ACF_3 = "/opt/booster_pack/fp8_group_quant_3.acf"
ACF_6 = "/opt/booster_pack/fp8_group_quant_6.acf"
...
SHAPE_CONFIGS: dict[tuple, helion.Config] = {
    ...
    (256, 4096, 128): helion.Config(block_sizes=[128], indexing="tensor_descriptor", num_warps=8, num_stages=3, advanced_controls_file=ACF_0),
    (256, 8192, 128): helion.Config(block_sizes=[128], indexing="tensor_descriptor", num_warps=8, num_stages=3, advanced_controls_file=ACF_3),
    (4096, 7168, 128): helion.Config(block_sizes=[256], indexing="tensor_descriptor", num_warps=8, num_stages=4, advanced_controls_file=ACF_6),
}
