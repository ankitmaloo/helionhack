...
SHAPE_CONFIGS: dict[tuple, helion.Config] = {
    (1, 256, 64): helion.Config(block_sizes=[2], num_warps=4, num_stages=1),
    (4, 512, 128): helion.Config(block_sizes=[4], num_warps=4, num_stages=1),
    (16, 1024, 64): helion.Config(block_sizes=[16], num_warps=4, num_stages=2),
    (1, 4096, 128): helion.Config(block_sizes=[4], num_warps=4, num_stages=1),
    (8, 4096, 128): helion.Config(block_sizes=[16], num_warps=4, num_stages=2),
    (256, 4096, 128): helion.Config(block_sizes=[64], pid_type="persistent_interleaved", num_warps=4, num_stages=2),
    (256, 8192, 128): helion.Config(block_sizes=[128], pid_type="persistent_interleaved", num_warps=8, num_stages=3),
    (4096, 7168, 128): helion.Config(block_sizes=[128], pid_type="persistent_interleaved", num_warps=8, num_stages=3),
}
