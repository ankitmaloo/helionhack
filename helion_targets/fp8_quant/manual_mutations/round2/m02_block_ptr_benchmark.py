...
SHAPE_CONFIGS: dict[tuple, helion.Config] = {
    ...
    (256, 4096, 128): helion.Config(block_sizes=[64], indexing="block_ptr", num_warps=4, num_stages=1),
    (256, 8192, 128): helion.Config(block_sizes=[64], indexing="block_ptr", num_warps=4, num_stages=1),
    (4096, 7168, 128): helion.Config(block_sizes=[64], indexing="block_ptr", num_warps=4, num_stages=1),
}
