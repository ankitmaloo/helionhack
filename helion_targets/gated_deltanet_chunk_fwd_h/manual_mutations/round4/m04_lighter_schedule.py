...
SHAPE_CONFIGS: dict[tuple, helion.Config] = {
    ...
    # Drop warps/stages for large shapes to free registers
    (2, 512, 3, 64, 64): helion.Config(block_sizes=[64], indexing="tensor_descriptor", num_warps=4, num_stages=2),
    (2, 1024, 3, 64, 64): helion.Config(block_sizes=[64], indexing="tensor_descriptor", num_warps=4, num_stages=2),
}
# EVOLVE-BLOCK-END
