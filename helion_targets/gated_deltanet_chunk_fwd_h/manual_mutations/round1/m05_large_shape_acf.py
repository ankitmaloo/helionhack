...
SHAPE_CONFIGS: dict[tuple, helion.Config] = {
    ...
    (2, 512, 3, 64, 64): helion.Config(block_sizes=[64], num_warps=8, num_stages=2, advanced_controls_file=ACF_0),
    (2, 1024, 3, 64, 64): helion.Config(block_sizes=[64], num_warps=8, num_stages=3, advanced_controls_file=ACF_1),
}
