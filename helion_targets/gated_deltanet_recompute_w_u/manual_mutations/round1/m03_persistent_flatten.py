...
SHAPE_CONFIGS: dict[tuple, tuple[helion.Config, helion.Config]] = {
    ...
    (1, 256, 4, 64, 128): (
        helion.Config(block_sizes=[64], flatten_loops=True, pid_type="persistent_interleaved", num_warps=4, num_stages=2),
        helion.Config(block_sizes=[64], flatten_loops=True, pid_type="persistent_interleaved", num_warps=8, num_stages=2),
    ),
    (1, 64, 1, 64, 64): (
        helion.Config(block_sizes=[64], flatten_loops=True, pid_type="persistent_interleaved", num_warps=4, num_stages=2),
        helion.Config(block_sizes=[64], flatten_loops=True, pid_type="persistent_interleaved", num_warps=4, num_stages=2),
    ...
    (2, 1024, 3, 64, 64): (
        helion.Config(block_sizes=[64], flatten_loops=True, pid_type="persistent_interleaved", num_warps=8, num_stages=3),
        helion.Config(block_sizes=[64], flatten_loops=True, pid_type="persistent_interleaved", num_warps=8, num_stages=3),
    ),
}
