...
SHAPE_CONFIGS: dict[tuple, tuple[helion.Config, helion.Config]] = {
    ...
    (1, 256, 4, 64, 128): (
        helion.Config(block_sizes=[64], indexing="tensor_descriptor", num_warps=4, num_stages=2, advanced_controls_file=ACF_0),
        helion.Config(block_sizes=[64], indexing="tensor_descriptor", num_warps=8, num_stages=2, advanced_controls_file=ACF_1),
    ),
    (1, 64, 1, 64, 64): (
        helion.Config(block_sizes=[64], indexing="tensor_descriptor", num_warps=4, num_stages=2, advanced_controls_file=ACF_0),
        helion.Config(block_sizes=[64], indexing="tensor_descriptor", num_warps=4, num_stages=2, advanced_controls_file=ACF_1),
    ),
    (2, 512, 3, 64, 64): (
        helion.Config(block_sizes=[64], indexing="tensor_descriptor", num_warps=8, num_stages=2, advanced_controls_file=ACF_0),
        helion.Config(block_sizes=[64], indexing="tensor_descriptor", num_warps=8, num_stages=2, advanced_controls_file=ACF_1),
    ),
    (2, 1024, 3, 64, 64): (
        helion.Config(block_sizes=[64], indexing="tensor_descriptor", num_warps=8, num_stages=3, advanced_controls_file=ACF_0),
        helion.Config(block_sizes=[64], indexing="tensor_descriptor", num_warps=8, num_stages=3, advanced_controls_file=ACF_1),
    ),
}
