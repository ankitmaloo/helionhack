...
SHAPE_CONFIGS = {
    ...
    (2, 512, 3, 64, 64): (
        ...
        helion.Config(block_sizes=[32], indexing="tensor_descriptor", num_warps=8, num_stages=3),
    ),
    (2, 1024, 3, 64, 64): (
        helion.Config(block_sizes=[32], num_warps=8, num_stages=3),
        helion.Config(block_sizes=[32], indexing="tensor_descriptor", num_warps=8, num_stages=4),
    ),
}
